...
def fit_naive_bayes(path, saveto=None, cv=12):
    ...
    if saveto is None:
        saveto = "../data/naive_bayes_{}.pkl".format(time.time())
...
def fit_logistic_regression(path, saveto=None, cv=12):
    ...
    if saveto is None:
        saveto = "../data/logistic_regression_{}.pkl".format(time.time())
...
def fit_multilayer_perceptron(path, saveto=None, cv=12):
    ...
    if saveto is None:
        saveto = "../data/multilayer_perceptron_{}.pkl".format(time.time())
