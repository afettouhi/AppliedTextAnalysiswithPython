...
def train_model(path, model, saveto=None, cv=12, **kwargs):
    ...
    # Compute cross validation scores mp note: http://scikit-learn.org/stable/faq.html#why-do-i-sometime-get-a-crash
    # -freeze-with-n-jobs-1-under-osx-or-linux
...
if __name__ == '__main__':
    ...
    cpath = '../data/review_corpus_proc'
    mpath = {
        'keras_model': '../data/ktf/keras_nn.h5',
        'sklearn_pipe': '../data/ktf/pipeline.pkl'
    }
